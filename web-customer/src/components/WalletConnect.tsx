...
export default function WalletConnect() {
  ...
  return (
    <div className="flex items-center gap-4">
      <div
        className={cn(
          "[&_.wallet-adapter-button]:!bg-primary [&_.wallet-adapter-button]:!text-primary-foreground [&_.wallet-adapter-button]:!rounded-xl [&_.wallet-adapter-button]:!font-semibold [&_.wallet-adapter-button]:!px-6 [&_.wallet-adapter-button]:!h-10",
